...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None):
        B, T = idx.shape
        assert T <= self.config.block_size, f"Max context limit reached : {self.config.block_size}!"
    ...
    def generate_samples(self, start_string: str, num_return_sequences: int, max_length: int, device: torch.device = "cpu"):
